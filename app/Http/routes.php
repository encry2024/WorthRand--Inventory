                        ...
                        $excel->sheet('WorthRand Inventory PO', function($sheet) use ($buyAndSellProposal, $excel) {
                            ...
                            $selectedItems = DB::table('buy_and_sell_proposal_item')
                                ->select('projects.*',
                                    ...
                                    DB::raw('wr_crm_buy_and_sell_proposal_item.id as "buy_and_sell_item_id"'),
                                    DB::raw('wr_crm_buy_and_sell_proposal_item.quantity as "buy_and_sell_item_quantity"'),
                                    DB::raw('wr_crm_buy_and_sell_proposal_item.delivery as "buy_and_sell_item_delivery"'),
                                    DB::raw('wr_crm_buy_and_sell_proposal_item.price as "buy_and_sell_item_price"'),
                                    DB::raw('wr_crm_buy_and_sell_proposal_item.notify_me_after as "buy_and_sell_item_notify_me_after"'))
                                ->leftJoin('projects', function($join) {
    ...
    Route::group(['middleware' => ['verify_if_user_is_sales_engineer']], function() {
        Route::group(['prefix' => 'sales_engineer'], function() {
            ...
            # CUSTOMERS
                ...
                Route::get('/fetch_customers', 'SalesEngineer\CustomerController@fetchCustomers');
