...
<div class="row" style="margin-top: -2rem;">
   <div class="alert error alert-dismissible" role="alert" style="border-radius: 0px; border-radius: 0px; background-image: none;">
      <i class="fa fa-remove" style="margin-left: 18rem;"></i>&nbsp;&nbsp;<b>{{ Session::get('message') }}</b>
