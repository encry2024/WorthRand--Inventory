      ...
      <div class="row">
         <div class="panel panel-default">
            <div class="panel-heading" style="border-top: saddlebrown 3px solid;">
               <h4><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;ADD PRICING HISTORY FOR {{ strtoupper($afterMarket->name) }}</h4>
            </div>
         </div>
      </div>
...
$("#price").on("focusout", function(e) {
   e.preventDefault();
   var afterMarketPricingHistory = document.getElementById("price").value
   string = numeral(afterMarketPricingHistory).format('0,0.00');
