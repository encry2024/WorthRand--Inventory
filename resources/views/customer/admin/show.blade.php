               ...
               <div class="col-lg-12">
                  <form class="form-horizontal">
                     ...
                     <div class="form-group{{ $errors->has('contact_person') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                           <label id="contact_person" class="control-label">{{ $customer->contact_person }}</label>
                        </div>
                     </div>
                     ...
                     <div class="form-group{{ $errors->has('position_of_contact_person') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                           <label id="position_of_contact_person" class="control-label">{{ $customer->position_of_contact_person }}</label>
                        </div>
                     </div>
