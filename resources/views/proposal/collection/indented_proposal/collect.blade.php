    ...
    @if(Session::has('message'))
        <div class="row" style="margin-top: -2rem;">
            <div class="alert {{ Session::get('alert') }} alert-dismissible" role="alert" style="border-radius: 0px;">
                <b><i style="margin-left: 18rem;" class="fa fa-check"></i>&nbsp;&nbsp;{{ Session::get('message') }}</b>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="list-group">
                    @if($indentedProposal->collection_status != "COMPLETED")
                    <a href="javascript:void(0)" class="list-group-item" style="font-size: 13px;" data-toggle="modal" data-target="#collectionIndentedProposalForm"><i class="fa fa-check"></i>&nbsp;&nbsp;Accept Proposal</a>
                    @endif
                    <a href="{{ route('collection_dashboard') }}" class="list-group-item" style="font-size: 13px;"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Back</a>
                </div>
            </div>
