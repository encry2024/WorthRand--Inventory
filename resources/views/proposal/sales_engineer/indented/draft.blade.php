        ...
        <div class="col-lg-12">
            ...
            <div class="col-md-3">
                <div class="list-group">
                    <a href="#send_proposal" onclick='document.getElementById("SubmitIndentedProposal").submit();' style="font-size: 13px;">
                        <i class="fa fa-paper-plane"></i>&nbsp;&nbsp;Send Proposal
                    </a>
                    <a class="nav-link"  href="{{ route('se_dashboard') }}"><i class="fa fa-arrow-left"></i>
                        <i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Send Proposal
                    </a>
                </div>
            </div>
